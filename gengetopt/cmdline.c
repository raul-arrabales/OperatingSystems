...
const char *gengetopt_args_info_usage = "Usage: ssoo [OPTIONS]...";
...
const char *gengetopt_args_info_help[] = {
  ...
  "  -k, --directory=STRING  directory-to-fetch  (default=`.')",
  "  -t, --file-type=STRING  file-type-option",
    0
};
...
void clear_args (struct gengetopt_args_info *args_info)
{
  ...
  args_info->file_type_arg = NULL;
  args_info->file_type_orig = NULL;
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->file_type_help = gengetopt_args_info_help[3] ;
...
cmdline_parser_release (struct gengetopt_args_info *args_info)
{
  ...
  free_string_field (&(args_info->file_type_arg));
  free_string_field (&(args_info->file_type_orig));
...
cmdline_parser_dump(FILE *outfile, struct gengetopt_args_info *args_info)
{
  ...
  if (args_info->file_type_given)
    write_into_file(outfile, "file-type", args_info->file_type_orig, 0);
  ...
  while (1)
    {
      ...
      c = custom_getopt_long (argc, argv, "hVk:t:", long_options, &option_index);
      ...
      switch (c)
        ...
        case 'k':	/* directory-to-fetch.  */
          ...
          break;
        case 't':	/* file-type-option.  */
        
        
          if (update_arg( (void *)&(args_info->file_type_arg), 
               &(args_info->file_type_orig), &(args_info->file_type_given),
              &(local_args_info.file_type_given), optarg, 0, 0, ARG_STRING,
              check_ambiguity, override, 0, 0,
              "file-type", 't',
              additional_error))
            goto failure;

...
/*
  ...
  gengetopt --input=script.cmdline --include-getopt 
...
const char *gengetopt_args_info_purpose = "OS assignment";

const char *gengetopt_args_info_usage = "Usage: myScript [OPTIONS]...";
...
const char *gengetopt_args_info_help[] = {
  ...
  "  -d, --Directory=STRING   Input Directory",
  "  -t, --ObjectType=STRING  ",
  "  -c, --String=STRING      File Name Match",
  "  -p, --Perms=STRING       File Permissions",
...
void clear_given (struct gengetopt_args_info *args_info)
{
  ...
  args_info->ObjectType_given = 0 ;
  args_info->String_given = 0 ;
  args_info->Perms_given = 0 ;
...
void clear_args (struct gengetopt_args_info *args_info)
{
  ...
  args_info->ObjectType_arg = NULL;
  args_info->ObjectType_orig = NULL;
  args_info->String_arg = NULL;
  args_info->String_orig = NULL;
  args_info->Perms_arg = NULL;
  args_info->Perms_orig = NULL;
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->Directory_help = gengetopt_args_info_help[2] ;
  args_info->ObjectType_help = gengetopt_args_info_help[3] ;
  args_info->String_help = gengetopt_args_info_help[4] ;
  args_info->Perms_help = gengetopt_args_info_help[5] ;
  args_info->Action_help = gengetopt_args_info_help[6] ;
...
cmdline_parser_release (struct gengetopt_args_info *args_info)
{
  ...
  free_string_field (&(args_info->ObjectType_arg));
  free_string_field (&(args_info->ObjectType_orig));
  free_string_field (&(args_info->String_arg));
  free_string_field (&(args_info->String_orig));
  free_string_field (&(args_info->Perms_arg));
  free_string_field (&(args_info->Perms_orig));
  free_string_field (&(args_info->Action_arg));
...
cmdline_parser_dump(FILE *outfile, struct gengetopt_args_info *args_info)
{
  ...
  if (args_info->ObjectType_given)
    write_into_file(outfile, "ObjectType", args_info->ObjectType_orig, 0);
  if (args_info->String_given)
    write_into_file(outfile, "String", args_info->String_orig, 0);
  if (args_info->Perms_given)
    write_into_file(outfile, "Perms", args_info->Perms_orig, 0);
...
cmdline_parser_required2 (struct gengetopt_args_info *args_info, const char *prog_name, const char *additional_error)
{
  ...
  if (! args_info->ObjectType_given)
    {
      fprintf (stderr, "%s: '--ObjectType' ('-t') option required%s\n", prog_name, (additional_error ? additional_error : ""));
      error = 1;
    }
  
  if (! args_info->String_given)
    {
      fprintf (stderr, "%s: '--String' ('-c') option required%s\n", prog_name, (additional_error ? additional_error : ""));
      error = 1;
    }
  
  if (! args_info->Perms_given)
    {
      fprintf (stderr, "%s: '--Perms' ('-p') option required%s\n", prog_name, (additional_error ? additional_error : ""));
      error = 1;
    }
  ...
  while (1)
    {
      ...
      c = custom_getopt_long (argc, argv, "hVd:t:c:p:a:", long_options, &option_index);
      ...
      switch (c)
        ...
        case 't':	/* .  */
          ...
          if (update_arg( (void *)&(args_info->ObjectType_arg), 
               &(args_info->ObjectType_orig), &(args_info->ObjectType_given),
              &(local_args_info.ObjectType_given), optarg, 0, 0, ARG_STRING,
              check_ambiguity, override, 0, 0,
              "ObjectType", 't',
              additional_error))
            goto failure;
        ...
        case 'c':	/* File Name Match.  */
          ...
          break;
        case 'p':	/* File Permissions.  */
        
        
          if (update_arg( (void *)&(args_info->Perms_arg), 
               &(args_info->Perms_orig), &(args_info->Perms_given),
              &(local_args_info.Perms_given), optarg, 0, 0, ARG_STRING,
              check_ambiguity, override, 0, 0,
              "Perms", 'p',
              additional_error))
            goto failure;
        ...
        case 'a':	/* Action.  */
          ...
          if (update_arg( (void *)&(args_info->Action_arg), 
              ...
              &(local_args_info.Action_given), optarg, 0, 0, ARG_STRING,
              check_ambiguity, override, 0, 0,
              "Action", 'a',
              additional_error))
            goto failure;
